...
public:
  ...
  /// \pram body An unary director to build up the content of the while loop's body.
  ...
  /// \param inc A statement director to build up the increment expression. Depending on the target language this director may be invoked multiple times. Once for the regular loop increment and once for each continue.
...
private:
  ...
  bool buildDoStmtImpl(StmtDirector& cond, Director& body)
  {
